...
class RegisterForm(forms.ModelForm):
    ...
    class Meta:
        model=User
        fields=['first_name','last_name','email','password','user_type','profile_description','profile_image']
        widgets={
            ...
            'profile_image':forms.URLInput(attrs={'class':'form-control','placeholder':'imagen_url'}),
        }
